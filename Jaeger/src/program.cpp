...
void Program::Function::assemble( std::ostream& output, Program* program )
{
    ...
    else if( m_coroutine )
    {
        ...
        output << "jif $temp->$state->$___waitForUid___ %testWaitForUid %call;" << std::endl;
        ...
        output << "jif $isnil %skipSetPrevSetFirst %setPrev;" << std::endl;
        output << "skipSetPrevSetFirst:" << std::endl;
        output << "mov void $next => $c_" << makeUID() << "___queueFirst;" << std::endl;
        output << "goto %skipSetPrev;" << std::endl;
        ...
        output << "jif $isnil %skipSetNextSetLast %setNext;" << std::endl;
        output << "skipSetNextSetLast:" << std::endl;
        output << "mov void $prev => $c_" << makeUID() << "___queueLast;" << std::endl;
        output << "goto %skipSetNext;" << std::endl;
        ...
        output << "jif $isnil %testEmptyFirst %testFirst;" << std::endl;
        ...
        output << "testEmptyFirst:" << std::endl;
        output << "nil $c_" << makeUID() << "___queueFirst => $isnil;" << std::endl;
        output << "jif $isnil %exitEmpty %testEmptyLast;" << std::endl;
        output << "testEmptyLast:" << std::endl;
        output << "nil $c_" << makeUID() << "___queueLast => $isnil;" << std::endl;
        output << "jif $isnil %exitEmpty %exitNonEmpty;" << std::endl;
